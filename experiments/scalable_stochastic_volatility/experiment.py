...
parser.add_argument("--T", dest="T", type=int, default=64)
...
parser.add_argument("--n-samples", dest="n_samples", type=int, default=10)
parser.add_argument("--adaptation", dest="adaptation", type=int, default=10)
...
def one_experiment(key):
    ...
    if args.bpf_init:
        ...
        # intentionally bad initialisation to test convergence
