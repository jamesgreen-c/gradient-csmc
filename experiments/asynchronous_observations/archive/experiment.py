...
def one_experiment(key):
    ...
    kernel_, init, _, _ = kernel_type.kernel_maker(m0, ys, inds, args.D, PHI, chol_P0, chol_Q, N=args.N,
...
xs_all = np.empty((args.K, args.M, args.D, args.D))
Bs_all = np.empty((args.K, args.M, args.D))
log_ws_all = np.empty((args.K, args.M, args.D, args.N+1))
ess_all = np.empty((args.K, args.M, args.D))
...
experiment_name = "kernel={},D={},N={},logvar={},style={},seed={}"
