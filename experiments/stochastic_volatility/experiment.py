...
for k, key_k in enumerate(EXPERIMENT_KEYS):
    ...
    means_k, std_k, ess_k, final_pct_k, energy_k, init_xs_k, true_xs_k, ys_k, adapted_delta_k, sample_time_k, samples_iacf_k = one_experiment(key_k)
    # print(final_pct_k.shape)
    # print(samples_iacf_k.shape)
